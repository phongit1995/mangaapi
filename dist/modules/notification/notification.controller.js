...
__decorate([
    common_1.Post("test-notification-devices"),
    swagger_1.ApiOperation({ summary: "Test notification" }),
    swagger_1.ApiResponse({ status: 200, description: 'test success.' }),
    common_1.UsePipes(new common_1.ValidationPipe({ transform: true })),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [notification_dto_1.dtoTestNotificationDevice]),
    __metadata("design:returntype", Promise)
], NotificationController.prototype, "testNotificationSenDevices", null);
